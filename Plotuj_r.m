function Plotuj_r(r, t, tytul, legenda, labele, label_x, plik_t, ustawienia)
% pomocnicza funkcja tworząca wykres dwóch zmiennych od czasu według opisów
...
% spis kolorow
col_x = ustawienia.col_x;
col_y = ustawienia.col_y;
...
wykres = figure('Visible', ustawienia.wyswietl);
    ...
    plot(t, r(1, :), "LineWidth", other_plotWidth, "Color", col_x);
    plot(t, r(2, :), "LineWidth", other_plotWidth, "Color", col_y);
